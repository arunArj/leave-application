...
<head>
    ...
    <title>{{ config('app.name', 'Leave App') }}</title>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                    <div class="sidebar-brand-icon">
                        <img class="logo-image" src="{{ URL::to('/') }}/theme/img/logo_kreata.png">
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('dashboard/companys/create')}}">Manage Company</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsethree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('dashboard/settings/edit/340')}}">Manage Leave Settings</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsefive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('/dashboard/employees/create')}}">Add Employee</a>
                            <a class="collapse-item" href="{{url('/dashboard/employees/')}}">Empolyees List</a>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{url('/dashboard/product')}}">
...
@endif
    ...
    <script src="https://code.jquery.com/jquery-3.6.3.js" id="" crossorigin="anonymous"></script>
