            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="/dashboard/departments">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="reporting_emails" id="tag-input1"  placeholder="Email Address">
...
<script>
   console.log("{{old('reporting_emails')}}");
